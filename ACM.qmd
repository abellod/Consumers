...
Como en el ACM existen ejes que se consideran "parásitos", se utiliza el \textbf{Criterio de Benzécri} para determinar con cuantos ejes realizar el ACM. Luego de aplicar dicho criterio, se obtiene la siguiente inercia para los ejes:
