...
# Análisis de Correspondencias Múltiples sin considerar "Desconocido"
...
```{r}
#| echo: false
fviz_contrib(res.mca, choice = "var", axes = 2, top = 4) # top=6 para que muestre quienes contribuyen más
```
...
kable(coord[22:23,1:2], digits = 4)
```
...
kable(val_test[22:23,1:2], digits = 4)
...
kable(coord[24:25,1:2], digits = 4)
```
...
kable(val_test[24:25,1:2], digits = 4)
...
kable(coord[26:27,1:2], digits = 4)
```
...
kable(val_test[26:27,1:2], digits = 4)
...
kable(coord[28:29,1:2], digits = 4)
```
...
kable(val_test[28:29,1:2], digits = 4)
...
kable(coord[30:31,1:2], digits = 4)
```
...
kable(val_test[30:31,1:2], digits = 4)
